...
/**
 * This class just defines types, you should import Spliterator$OfLong instead of this.
...
export declare class Spliterator$OfLongClass extends JavaClass {
     ...
     * @return original return type: 'boolean'
     */
    public tryAdvance(var0: java_util_function_LongConsumer | null): Promise<boolean>;
    /**
     * @param var0 original type: 'java.util.function.LongConsumer'
     * @return original return type: 'boolean'
     */
    public tryAdvanceSync(var0: java_util_function_LongConsumer | null): boolean;
    /**
     ...
     */
    public trySplit(): Promise<Spliterator$OfLong | null>;
    /**
     * @return original return type: 'java.util.Spliterator$OfLong'
     */
    public trySplitSync(): Spliterator$OfLong | null;
 ...
 * The class Spliterator$OfLongClass only defines types, this is the class you should actually import.
 * Please note that this statement imports the underlying java class at runtime, which may take a while.
 * This was generated by java-bridge.
 * You should probably not edit this.
 */
export class Spliterator$OfLong extends importClass<typeof Spliterator$OfLongClass>("java.util.Spliterator$OfLong") {
    /**
