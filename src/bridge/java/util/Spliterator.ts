...
/**
 * This class just defines types, you should import Spliterator instead of this.
...
export declare class SpliteratorClass extends JavaClass {
     ...
     */
    public trySplit(): Promise<Spliterator | null>;
    // ================== Method trySplit ==================
    /**
     * @return original return type: 'java.util.Spliterator'
     */
    public trySplitSync(): Spliterator | null;
    // ================== Method estimateSize ==================
    /**
 ...
 * The class SpliteratorClass only defines types, this is the class you should actually import.
 * Please note that this statement imports the underlying java class at runtime, which may take a while.
 * This was generated by java-bridge.
 * You should probably not edit this.
 */
export class Spliterator extends importClass<typeof SpliteratorClass>("java.util.Spliterator") {
    /**
