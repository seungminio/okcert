...
/**
 * This class just defines types, you should import Set instead of this.
 ...
 * The class SetClass only defines types, this is the class you should actually import.
 * Please note that this statement imports the underlying java class at runtime, which may take a while.
 * This was generated by java-bridge.
 * You should probably not edit this.
 */
export class Set extends importClass<typeof SetClass>("java.util.Set") {
    /**
