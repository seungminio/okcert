...
/**
 * This class just defines types, you should import WritableByteChannel instead of this.
 ...
 * The class WritableByteChannelClass only defines types, this is the class you should actually import.
 * Please note that this statement imports the underlying java class at runtime, which may take a while.
 * This was generated by java-bridge.
 * You should probably not edit this.
 */
export class WritableByteChannel extends importClass<typeof WritableByteChannelClass>("java.nio.channels.WritableByteChannel") {
    /**
